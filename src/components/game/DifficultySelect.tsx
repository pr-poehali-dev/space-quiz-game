          ...
          <div className="mt-3 flex justify-center gap-2">
            {difficulties.map(d => (
              <div
                ...
                style={{
                  background: solvedDifficulties.includes(d) ? DIFFICULTY_CONFIG[d].color : 'rgba(255,255,255,0.15)',
                  boxShadow: solvedDifficulties.includes(d) ? `0 0 8px ${DIFFICULTY_CONFIG[d].color}` : 'none',
                }}
              />
            ))}
          </div>
